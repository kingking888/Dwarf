...
from PyQt5.QtWidgets import QSplitter, QTabWidget, QTabBar, QVBoxLayout, QWidget, QDockWidget
...
class SessionUi(QTabWidget):
    ...
    def build_left_column(self):
        ...
        self.watchers_dock = QDockWidget('Watchers')
        self.watchers_panel = WatchersPanel(self.app)
        self.watchers_dock.setWidget(self.watchers_panel)
        self.app.app_window.addDockWidget(Qt.RightDockWidgetArea, self.watchers_dock)
    ...
    def build_central_content(self):
        ...
        self.memory_panel.statusChanged.connect(self.on_status_text)
    ...
    def on_memory_modified(self, position, length):
        """ simple example
        """
        print('modified pos: {0} {1}'.format(position, length))

    def on_status_text(self, txt):
        self.app.app_window.statusbar.showMessage(txt)
